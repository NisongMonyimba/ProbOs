...
2 & Sequential inference + C++ into Python package &
  ...
  PLANNED \\
3 & Directional --- likely candidates: GPU kernel path, PDSL v0.2
  (control flow), broader distribution library &
  To be planned in detail at the end of Month 2 &
  DIRECTIONAL \\
4 & Directional --- likely candidates: packaging/release, documentation
  site, expanded model library &
  To be planned in detail at the end of Month 3 &
  DIRECTIONAL \\
\bottomrule
\end{longtable}
